...
El programa debe solicitar ahora el nombre de un alumno y la cantidad de cursos en la que se encuentra inscripto. 
- Estos dos valores deben almacenarse como una lista de dos elementos (el primero el nombre, el segundo la cantidad de cursos como un número entero) en una lista de alumnos. 
